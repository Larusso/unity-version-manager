...
pub fn get_android_open_jdk_download_info<V: AsRef<Version>>(version:V) -> ModulePart {
    ...
    if *version >= Version::a(2022,2,0,0) {
        ( "11.0.14.1-1", "c17a2ae6fe1b4281fb613fed32027cf93e0251795387941bd8c1fcb6c74f9db4", 239_521_958, 121_536_013)
    } else {
        ( "8u172-b11", "4be8440cc514099cfe1b50cbc74128f6955cd90fd5afe15ea7be60f832de67b4", 162_000_000, 73_170_000)
    };
    ...
    ModulePart {
        ...
        download_url: format!("http://download.unity3d.com/download_unity/open-jdk/open-jdk-linux-x64/jdk{}_{}.zip", version, checksum),
...
pub fn get_android_sdk_build_tools_download_info<V: AsRef<Version>>(version:V) -> ModulePart {
    ...
    ModulePart {
        ...
        installed_size: install_size,
        download_size: download_size,
        rename_from: Some(Path::new(&format!("{{UNITY_PATH}}/Editor/Data/PlaybackEngines/AndroidPlayer/SDK/build-tools/android-{}", android_version)).to_path_buf()),
...
pub fn get_android_sdk_platform_download_info<V: AsRef<Version>>(version:V) -> ModulePart {
    ...
    ModulePart {
        ...
        installed_size: install_size,
        download_size: download_size,
        rename_from: Some(Path::new(&format!("{{UNITY_PATH}}/Editor/Data/PlaybackEngines/AndroidPlayer/SDK/platforms/android-{}", android_version)).to_path_buf()),
