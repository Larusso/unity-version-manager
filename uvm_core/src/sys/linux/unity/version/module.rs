...
pub fn get_android_sdk_ndk_download_info<V: AsRef<Version>>(version:V) -> Vec<ModulePart> {
    ...
    vec![
        ...
        ModulePart {
            ...
            rename_from: Some("{UNITY_PATH}/Editor/Data/PlaybackEngines/AndroidPlayer/SDK/build-tools/android-9".to_string()),
        ...
        ModulePart {
            ...
            rename_from: Some("{UNITY_PATH}/Editor/Data/PlaybackEngines/AndroidPlayer/SDK/platforms/android-9".to_string()),
