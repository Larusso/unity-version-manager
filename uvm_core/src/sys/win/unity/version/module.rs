...
pub fn get_android_open_jdk_download_info<V: AsRef<Version>>(_version:V) -> ModulePart {
    ModulePart {
        ...
        download_url: "http://download.unity3d.com/download_unity/open-jdk/open-jdk-win-x64/jdk8u172-b11_4be8440cc514099cfe1b50cbc74128f6955cd90fd5afe15ea7be60f832de67b4.zip".to_string(),
        version: "8u172-b11".to_string(),
        main: true,
        installed_size: 70_460_000,
        download_size: 153_000_000,
        rename_from: None,
        rename_to: None
    }
}
...
pub fn get_android_sdk_ndk_download_info<V: AsRef<Version>>(version:V) -> Vec<ModulePart> {
    ...
    vec![
        ...
        ModulePart {
            ...
            download_url: "https://dl.google.com/android/repository/build-tools_r28.0.3-windows.zip".to_string(),
        ...
        ModulePart {
            ...
            download_url: format!("https://dl.google.com/android/repository/android-ndk-{}-windows-x86_64.zip", ndk_version),
