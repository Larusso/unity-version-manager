...
pub fn get_android_open_jdk_download_info<V: AsRef<Version>>(version:V) -> ModulePart {
    ...
    if *version >= Version::a(2022,2,0,0) {
        ( "11.0.14.1-1", "236fc2e31a8b6da32fbcf8624815f509c51605580cb2c6285e55510362f272f8", 230_230_237, 118_453_231)
    } else {
        ( "8u172-b11", "4be8440cc514099cfe1b50cbc74128f6955cd90fd5afe15ea7be60f832de67b4", 165_000_000, 72_700_000)
    };
    // https://download.unity3d.com/download_unity/open-jdk/open-jdk-mac-x64/jdk11.0.14.1-1_236fc2e31a8b6da32fbcf8624815f509c51605580cb2c6285e55510362f272f8.zip
    ModulePart {
        component: Component::AndroidOpenJdk,
        name: "OpenJDK".to_string(),
        download_url: format!("http://download.unity3d.com/download_unity/open-jdk/open-jdk-mac-x64/jdk{}_{}.zip", version, checksum),
...
pub fn get_android_ndk_download_info<V: AsRef<Version>>(version:V) -> ModulePart {
    ...
    ModulePart {
        ...
        installed_size: install_size,
        download_size: download_size,
        rename_from: Some(Path::new(&format!("{{UNITY_PATH}}/PlaybackEngines/AndroidPlayer/NDK/android-ndk-{}" , version)).to_path_buf()),
        rename_to: Some(Path::new("{UNITY_PATH}/PlaybackEngines/AndroidPlayer/NDK").to_path_buf())
    }
}
...
pub fn get_android_sdk_build_tools_download_info<V: AsRef<Version>>(version:V) -> ModulePart {
    ...
    ModulePart {
        ...
        installed_size: install_size,
        download_size: download_size,
        rename_from: Some(Path::new(&format!("{{UNITY_PATH}}/PlaybackEngines/AndroidPlayer/SDK/build-tools/android-{}", android_version)).to_path_buf()),
        rename_to: Some(Path::new(&format!("{{UNITY_PATH}}/PlaybackEngines/AndroidPlayer/SDK/build-tools/{}", version)).to_path_buf())
    }
}
...
pub fn get_android_sdk_platform_download_info<V: AsRef<Version>>(version:V) -> ModulePart {
    ...
    ModulePart {
        ...
        installed_size: install_size,
        download_size: download_size,
        rename_from: Some(Path::new(&format!("{{UNITY_PATH}}/PlaybackEngines/AndroidPlayer/SDK/platforms/android-{}", android_version)).to_path_buf()),
        rename_to: Some(Path::new(&format!("{{UNITY_PATH}}/PlaybackEngines/AndroidPlayer/SDK/platforms/android-{}", sdk_version)).to_path_buf())
    }
}
